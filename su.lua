-- ============================================================
-- NEVERLOSE UI 1:1 + FULL FUNCTIONS
-- ============================================================
...
local C={
    ...
    LegitE=false,LegitK="M2",LegitF=200,LegitS=15,LegitHit="Balaclava",
    RageE=false,RageK="M1",RageF=300,RageHit="Balaclava",
    RageAuto=false,RageS=5,RageTarget="Nearest",
...
local BGC=Color3.fromRGB(13,17,23)
local SIDE=Color3.fromRGB(10,13,18)
local TOP=Color3.fromRGB(16,20,28)
local ROW=Color3.fromRGB(20,26,36)
local TXT=Color3.fromRGB(230,235,245)
local DIM=Color3.fromRGB(90,100,120)
local MID=Color3.fromRGB(140,155,180)
local ACC=Color3.fromRGB(40,90,220)
local ACC2=Color3.fromRGB(70,130,255)
local ACCBG=Color3.fromRGB(25,40,80)
local OFF=Color3.fromRGB(45,50,65)
...
W.Size=UDim2.new(0,800,0,540) W.Position=UDim2.new(0.5,-400,0.5,-270)
...
WStroke.Color=Color3.fromRGB(35,45,65) WStroke.Thickness=1 WStroke.Transparency=0.3

local TB=Instance.new("Frame")
TB.Size=UDim2.new(1,0,0,52) TB.BackgroundColor3=TOP TB.BorderSizePixel=0 TB.Parent=W
...
Logo.Size=UDim2.new(0,300,1,0) Logo.Position=UDim2.new(0,22,0,0)
Logo.BackgroundTransparency=1 Logo.Text="NEVERLOSE" Logo.TextColor3=TXT
Logo.TextSize=26 Logo.Font=Enum.Font.GothamBlack
Logo.TextXAlignment=Enum.TextXAlignment.Left Logo.Parent=TB

for i,pos in ipairs({-90,-64,-38}) do
    local l=Instance.new("TextLabel")
    l.Size=UDim2.new(0,22,0,22) l.Position=UDim2.new(1,pos,0.5,-11)
    l.BackgroundTransparency=1 l.Text=({"●","●","●"})[i]
    l.TextColor3=i==1 and Color3.fromRGB(255,95,86) or (i==2 and Color3.fromRGB(255,189,46) or Color3.fromRGB(39,201,63))
    l.TextSize=12 l.Font=Enum.Font.GothamBold
    l.TextXAlignment=Enum.TextXAlignment.Center l.Parent=TB
end

local SB=Instance.new("Frame")
SB.Size=UDim2.new(0,190,1,-52) SB.Position=UDim2.new(0,0,0,52)
SB.BackgroundColor3=SIDE SB.BorderSizePixel=0 SB.Parent=W

local SBScroll=Instance.new("ScrollingFrame")
SBScroll.Size=UDim2.new(1,0,1,-70) SBScroll.Position=UDim2.new(0,0,0,10)
SBScroll.BackgroundTransparency=1 SBScroll.BorderSizePixel=0
SBScroll.ScrollBarThickness=2 SBScroll.ScrollBarImageColor3=ACC
...
SBLayout.Padding=UDim.new(0,2) SBLayout.SortOrder=Enum.SortOrder.LayoutOrder

local pages={} local tabs={} local curTab=nil
local function showPage(id)
    for k,v in pairs(pages) do v.Visible=(k==id) end
end

local yy=0
local function sbGroup(t)
    local l=Instance.new("TextLabel")
    l.Size=UDim2.new(1,-24,0,22) l.Position=UDim2.new(0,16,0,0)
    l.BackgroundTransparency=1 l.Text=t l.TextColor3=DIM
    l.TextSize=11 l.Font=Enum.Font.GothamBold
    l.TextXAlignment=Enum.TextXAlignment.Left
    l.LayoutOrder=yy l.Parent=SBScroll
    yy=yy+1
    return l
end
...
local function sbTab(n,ic,id)
    ...
    b.Size=UDim2.new(1,-12,0,32) b.Position=UDim2.new(0,6,0,0)
    b.BackgroundColor3=SIDE b.BackgroundTransparency=1
    b.Text="" b.BorderSizePixel=0 b.AutoButtonColor=false
    b.LayoutOrder=yy b.Parent=SBScroll
    yy=yy+1
    Instance.new("UICorner",b).CornerRadius=UDim.new(0,6)

    local i=Instance.new("TextLabel")
    i.Name="IC" i.Size=UDim2.new(0,18,0,18) i.Position=UDim2.new(0,12,0.5,-9)
    i.BackgroundTransparency=1 i.Text=ic i.TextColor3=MID i.TextSize=15
    i.Font=Enum.Font.GothamBold i.TextXAlignment=Enum.TextXAlignment.Center
    i.Parent=b

    local t=Instance.new("TextLabel")
    t.Name="TX" t.Size=UDim2.new(1,-44,1,0) t.Position=UDim2.new(0,38,0,0)
    t.BackgroundTransparency=1 t.Text=n t.TextColor3=MID t.TextSize=13
    t.Font=Enum.Font.GothamMedium t.TextXAlignment=Enum.TextXAlignment.Left
    t.Parent=b

    b.MouseEnter:Connect(function()
        if curTab~=b then b.BackgroundColor3=Color3.fromRGB(18,24,34) b.BackgroundTransparency=0.4 end
    end)
    b.MouseLeave:Connect(function()
        if curTab~=b then b.BackgroundColor3=SIDE b.BackgroundTransparency=1 end
    end)
    b.MouseButton1Click:Connect(function()
        if curTab then
            curTab.BackgroundColor3=SIDE
            curTab.BackgroundTransparency=1
            curTab.IC.TextColor3=MID
            curTab.TX.TextColor3=MID
            curTab.TX.Font=Enum.Font.GothamMedium
        end
        curTab=b
        b.BackgroundColor3=ACCBG b.BackgroundTransparency=0
        i.TextColor3=ACC2
        t.TextColor3=TXT t.Font=Enum.Font.GothamBold
        showPage(id)
    end)
    tabs[id]=b
end
...
UB.Size=UDim2.new(1,0,0,60) UB.Position=UDim2.new(0,0,1,-60)
UB.BackgroundColor3=Color3.fromRGB(8,11,16) UB.BorderSizePixel=0 UB.Parent=SB

local avBG=Instance.new("Frame")
avBG.Size=UDim2.new(0,36,0,36) avBG.Position=UDim2.new(0,14,0,12)
avBG.BackgroundColor3=ROW avBG.BorderSizePixel=0 avBG.Parent=UB
Instance.new("UICorner",avBG).CornerRadius=UDim.new(1,0)
local avStroke=Instance.new("UIStroke",avBG)
avStroke.Color=ACC avStroke.Thickness=1.5 avStroke.Transparency=0.3
...
nm.Size=UDim2.new(1,-70,0,14) nm.Position=UDim2.new(0,58,0,14)
nm.BackgroundTransparency=1 nm.Text=LP.DisplayName nm.TextColor3=TXT
nm.TextSize=12 nm.Font=Enum.Font.GothamBold
nm.TextXAlignment=Enum.TextXAlignment.Left nm.Parent=UB

local expireTime=os.date("%d.%m %H:%M",os.time()+30*24*3600)
local tl=Instance.new("TextLabel")
tl.Size=UDim2.new(1,-70,0,12) tl.Position=UDim2.new(0,58,0,30)
tl.BackgroundTransparency=1 tl.Text="TILL "..expireTime tl.TextColor3=ACC2
tl.TextSize=10 tl.Font=Enum.Font.Gotham
tl.TextXAlignment=Enum.TextXAlignment.Left tl.Parent=UB

local CT=Instance.new("Frame")
CT.Size=UDim2.new(1,-190,1,-52) CT.Position=UDim2.new(0,190,0,52)
...
local function newPage(id)
    ...
    p.BorderSizePixel=0 p.ScrollBarThickness=3 p.ScrollBarImageColor3=ACC
...
local function section(parent,title)
    ...
    local l=Instance.new("UIListLayout")
    l.Padding=UDim.new(0,4) l.SortOrder=Enum.SortOrder.LayoutOrder l.Parent=s
    local t=Instance.new("TextLabel")
    t.Size=UDim2.new(1,0,0,20) t.BackgroundTransparency=1
    t.Text=title t.TextColor3=ACC2 t.TextSize=12 t.Font=Enum.Font.GothamBold
...
local function row(parent,name)
    ...
    r.Size=UDim2.new(1,0,0,28) r.BackgroundColor3=ROW
...
local function toggle(r,on,cb)
    ...
    pill.Size=UDim2.new(0,24,0,12) pill.Position=UDim2.new(1,-34,0.5,-6)
    pill.BackgroundColor3=on and ACC or OFF pill.BorderSizePixel=0 pill.Parent=r
    Instance.new("UICorner",pill).CornerRadius=UDim.new(1,0)
    local d=Instance.new("Frame")
    d.Size=UDim2.new(0,8,0,8)
    d.Position=on and UDim2.new(1,-10,0.5,-4) or UDim2.new(0,2,0.5,-4)
    d.BackgroundColor3=Color3.new(1,1,1) d.BorderSizePixel=0 d.Parent=pill
    Instance.new("UICorner",d).CornerRadius=UDim.new(1,0)
    local btn=Instance.new("TextButton")
    btn.Size=UDim2.new(0,70,1,0) btn.Position=UDim2.new(1,-70,0,0)
    btn.BackgroundTransparency=1 btn.Text="" btn.Parent=r
    local st=on
    btn.MouseButton1Click:Connect(function()
        st=not st
        if st then pill.BackgroundColor3=ACC d.Position=UDim2.new(1,-10,0.5,-4)
        else pill.BackgroundColor3=OFF d.Position=UDim2.new(0,2,0.5,-4) end
...
local function slider(r,key,minV,maxV,suf,dec)
    ...
    vl.TextColor3=TXT vl.TextSize=11 vl.Font=Enum.Font.Gotham
    vl.TextXAlignment=Enum.TextXAlignment.Right vl.Parent=r
    local bar=Instance.new("Frame")
    bar.Size=UDim2.new(0,90,0,4) bar.Position=UDim2.new(1,-192,0.5,-2)
...
local function keybind(r,key)
    local btn=Instance.new("TextButton")
    btn.Size=UDim2.new(0,90,0,20) btn.Position=UDim2.new(1,-102,0.5,-10)
    btn.BackgroundColor3=Color3.fromRGB(28,34,46) btn.Text=tostring(C[key])
    ...
    UIS.InputBegan:Connect(function(input,gpe)
        ...
        C[key]=nk btn.Text=nk btn.BackgroundColor3=Color3.fromRGB(28,34,46) listening=false
    end)
end
...
local function dropdown(r,key,opts)
    ...
    vl.MouseButton1Click:Connect(function()
        ...
        lf.Size=UDim2.new(0,130,0,#opts*20+4) lf.Position=UDim2.new(1,-140,1,2)
        lf.BackgroundColor3=Color3.fromRGB(22,28,38) lf.BorderSizePixel=0
        ...
        for _,o in ipairs(opts) do
            ...
            ob.Size=UDim2.new(1,-4,0,19)
            ob.BackgroundColor3=Color3.fromRGB(22,28,38) ob.Text=o
            ...
            ob.MouseEnter:Connect(function() ob.BackgroundColor3=Color3.fromRGB(35,45,65) end)
            ob.MouseLeave:Connect(function() ob.BackgroundColor3=Color3.fromRGB(22,28,38) end)
...
toggle(row(r2,"Auto Fire"),false,function(v) C.RageAuto=v end)
...
uBtn.Size=UDim2.new(0,80,0,20) uBtn.Position=UDim2.new(1,-90,0.5,-10)
...
sbTab("Main","✕","Main")
sbTab("Inventory","▤","Main")
sbTab("Scripts","⌘","Main")
sbTab("Configs","⚙","Main")

curTab=tabs.Rage
if curTab then
    curTab.BackgroundColor3=ACCBG curTab.BackgroundTransparency=0
    curTab.IC.TextColor3=ACC2
    curTab.TX.TextColor3=TXT curTab.TX.Font=Enum.Font.GothamBold
end
showPage("Rage")
    ...
    mt.__newindex=newcclosure(function(self,key,value)
        if C.AAE and key=="CFrame" and typeof(value)=="CFrame" and typeof(self)=="Instance" then
            ...
            if char and self:IsDescendantOf(char) then
                ...
                elseif n=="Balaclava" or n=="Head" then
...
RS.Heartbeat:Connect(function()
    ...
    if ground and hum.FloorMaterial~=Enum.Material.Air then
        hum.Jump=true
    end
end)
